...
class GiantNougatMonster extends QuestEntity{
    ...
    constructor(quest: Quest, pos: Pos){
        ...
        //breaking change fix
        this.setCbc(new CollisionBoxCollection(new CollisionBox(this, new Pos(1, 0), new Pos(12, 1)),
                    new CollisionBox(this, new Pos(0, 1), new Pos(15, 2)),
                    new CollisionBox(this, new Pos(1, 3), new Pos(12, 1))));
