...
for tup in tupleList:
    ...
    #below is an attempt to fix the getascii error
    tupTemp = tup[1].replace('\\','/')
    ...
    #Below is an attempt to fix the error of bad storage

    # Write the beginning of the Database.addAscii() call
    ###############################################################
    ###############################################################
    outfile.write("Database.addAscii(\"" + tupTemp + "\", " + str(maxwidth-1) + ", " + str(height) + ", \n[\n")
